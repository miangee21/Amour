            ...
            <div className="space-y-10 text-paper-text font-body text-sm sm:text-base leading-relaxed">
              ...
              <div className="space-y-3">
                <h2 className="font-display text-xl sm:text-2xl text-primary font-medium flex items-center gap-2">
                  <span className="text-primary/50 text-lg">1.</span> Acceptance
                  of Terms
                </h2>
                <p className="pl-6 sm:pl-7 opacity-90">
                  By accessing or using Amour, you agree to be bound by these
              ...
              <div className="space-y-3">
                <h2 className="font-display text-xl sm:text-2xl text-primary font-medium flex items-center gap-2">
                  <span className="text-primary/50 text-lg">2.</span> Your
                  Letters
                </h2>
                <p className="pl-6 sm:pl-7 opacity-90">
                  You retain full ownership of your letters. You are responsible
                  for the content you create and share on our platform.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <h2 className="font-display text-xl sm:text-2xl text-primary font-medium flex items-center gap-2">
                  <span className="text-primary/50 text-lg">3.</span> Privacy &
                  Security
                </h2>
                <p className="pl-6 sm:pl-7 opacity-90">
                  Your privacy is our priority. We use industry-standard
                  security measures to protect your data and your words.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <h2 className="font-display text-xl sm:text-2xl text-primary font-medium flex items-center gap-2">
                  <span className="text-primary/50 text-lg">4.</span> Acceptable
                  Use
                </h2>
                <p className="pl-6 sm:pl-7 opacity-90">
                  Please use Amour respectfully. Do not use the platform for any
                  harmful, illegal, or abusive purposes.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <h2 className="font-display text-xl sm:text-2xl text-primary font-medium flex items-center gap-2">
                  <span className="text-primary/50 text-lg">5.</span> Changes
                </h2>
                <p className="pl-6 sm:pl-7 opacity-90">
